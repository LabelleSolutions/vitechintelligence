  ...
  return <>
    ...
    <main>
      <section className="hero"><div className="container hero-grid">
        ...
        <div className="hero-card"><img src="/assets/upbit-vina.embedded.svg" alt="Người học Việt Nam khám phá năng lực STEM"/></div>
      </div></section>
      ...
      <section className="section" id="readiness"><div className="container"><div className="section-head center"><span className="eyebrow">Career Readiness</span><h2>Từ trải nghiệm đến bằng chứng năng lực</h2></div><div className="feature-stack"><article className="feature-row"><div className="feature-media"><img src="/assets/career-readiness.embedded.svg" alt="Career readiness model"/></div><div className="feature-copy"><h3>Tiến bộ dễ hiểu cho người học và phụ huynh</h3><p>Theo dõi giao tiếp, phân tích, thiết kế, hợp tác, khả năng thích ứng và chất lượng thực thi.</p></div></article><article className="feature-row"><div className="feature-media"><img src="/assets/infrastructure.embedded.svg" alt="Simulation measurement and action"/></div><div className="feature-copy"><h3>Simulation → Measurement → Action</h3><p>Phát hiện khoảng trống kỹ năng và đề xuất dự án, coaching hoặc lộ trình tiếp theo; quyết định quan trọng vẫn do con người kiểm chứng.</p></div></article></div></div></section>
